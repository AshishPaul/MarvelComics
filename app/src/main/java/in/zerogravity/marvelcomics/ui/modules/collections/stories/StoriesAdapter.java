...
public class StoriesAdapter extends BaseRecyclerAdapter<CharacterUiModel> {


    public StoriesAdapter(ListItemClickListener<CharacterUiModel> listItemClickListener, EmptyViewClickListener emptyViewClickListener) {
        ...
        switch (viewType) {
            case NORMAL:
                itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_character,
                        parent, false);
                viewHolder = new StoryViewHolder(itemView, listItemClickListener);
                break;
            case EMPTY_LOADING:
    ...
    static class StoryViewHolder extends BaseViewHolder {

        private final ListItemClickListener<CharacterUiModel> listener;

        public StoryViewHolder(View itemView, ListItemClickListener<CharacterUiModel> listener) {
            super(itemView);
