...
public class CreatorsAdapter extends BaseRecyclerAdapter<CharacterUiModel> {


    public CreatorsAdapter(ListItemClickListener<CharacterUiModel> listItemClickListener, EmptyViewClickListener emptyViewClickListener) {
        ...
        switch (viewType) {
            case NORMAL:
                itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_character,
                        parent, false);
                viewHolder = new CreatorViewHolder(itemView, listItemClickListener);
                break;
            case EMPTY_LOADING:
    ...
    static class CreatorViewHolder extends BaseViewHolder {

        private final ListItemClickListener<CharacterUiModel> listener;

        public CreatorViewHolder(View itemView, ListItemClickListener<CharacterUiModel> listener) {
            super(itemView);
