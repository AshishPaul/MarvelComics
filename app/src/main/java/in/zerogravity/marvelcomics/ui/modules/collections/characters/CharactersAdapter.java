...
public class CharactersAdapter extends BaseRecyclerAdapter<CharacterUiModel> {


    public CharactersAdapter(ListItemClickListener<CharacterUiModel> listItemClickListener, EmptyViewClickListener emptyViewClickListener) {
    ...
    static class CharacterViewHolder extends BaseViewHolder {

        private final ListItemClickListener<CharacterUiModel> listener;

        public CharacterViewHolder(View itemView, ListItemClickListener<CharacterUiModel> listener) {
            super(itemView);
